...
\hypersetup{bookmarksopen,bookmarksopenlevel=3,linktocpage,colorlinks,urlcolor=blue,citecolor=blue,
						...
						pdftitle={Funcionalidad 3},
						pdfauthor={Juan Andrada Romero, Juan José Antequera Flores, Jose Domingo López López},
						pdfsubject={Modelos Avanzados de Bases de Datos}}
...
\input{PrimeraMitadWeb.tex}
\input{SegundaMitadWeb.tex}
\clearpage
\input{DosMitadesMultimedia.tex}
\clearpage
